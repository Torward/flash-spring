      ...
      <div>
        ...
        <Stack className="post-container">
          ...
          <div className="post-container__header">
            ...
            <Box className={'content-field w-1/3 h-[40px] flex justify-end items-center pt-6 pr-5 overflow-auto '} sx={{ margin: 'auto 0'}}>
              <Typography className={'flex justify-start items-center'}>{this.props.postContent}</Typography>
            </Box>
          </div>{" "}
          ...
          <div className="post-container__analitics">
            <Icon className="favorite" sx={{marginRight: 2,}}>
