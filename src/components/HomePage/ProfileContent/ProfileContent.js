...
import { Avatar, Icon, Stack, Grid } from "@mui/material";
...
class ProfileContent extends Component {
  ...
  changeValueState = () => {
    if (this.state.isChanged) this.setState({ isChanged: false });
        ...
        <Stack className={style.profile_content}>
          <Grid container>
            <div className={style.cover}>
              <img src={'https://ip1.anime-pictures.net/direct-images/332/332d0c3637b3383fa5d74f3197f13e8a.jpg?if=ANIME-PICTURES.NET_-_693005-8840x4940-ghost+blade-yan+%28ghost+blade%29-wlop-single-fringe-short+hair.jpg'} alt={'cover'}/>
            ...
            <div className={style.person}>
              <div className={style.person_info}>
                <div id={'age'} className={style.section} onClick={this.changeValueState}>
                ...
                <div id={'person-status'} className={style.section}>
                  ...
                  <span className={style.value}>{this.props.details}</span>
                </div>
